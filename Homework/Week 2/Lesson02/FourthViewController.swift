...
class FourthViewController: UIViewController {
    ...
    @IBAction func calculateFib(sender: AnyObject) {
        let newFibNum = FibonacciAdder(indexOfFibonacciNumber: numField.text.toInt())
        fibLabel.text = String(newFibNum.fibonacciNumberAtIndex())
    }
