...
Let's start with the bassics, a function is a reusable block of code that does something
...
func knockMultipleTimes(howManyKnocks: Int) {
    for index in 1...howManyKnocks {
        knockknock()
    }
}
