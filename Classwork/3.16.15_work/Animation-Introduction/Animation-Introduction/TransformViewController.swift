...
class TransformViewController: UIViewController {
    ...
    @IBAction func rotate(sender: UIBarButtonItem) {
        ...
        // JO: this will affect View Controller
    ...
    @IBAction func combination(sender: UIBarButtonItem) {
        ...
        //                                  transform here is referring to our variable we just defined
        
        // JO: note: CGAffineTransformScale not same as CGAffineTransformMakeScale
