...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        newLabel.layer.shadowColor = UIColor.darkGrayColor().CGColor
        newLabel.layer.shadowOffset = CGSizeMake(0, 3)
        newLabel.layer.shadowRadius = 1
        newLabel.layer.shadowOpacity = 0.4
        newLabel.layer.name = "label"
    }
    ...
    @IBAction func deleteAllLayers(sender: UIBarButtonItem) {
        ...
        for var index = 0; index < self.view.layer.sublayers.count; index++ {
            ...
            if let foo = self.view.layer.sublayers[index] as? CALayer {
                ...
                // JO says: this will just remove the shadow, I think
                if(foo.name == "label") {
    ...
    @IBAction func createArc(sender: AnyObject) {
        ...
        // JO: pronounced Bezz-ee-ay
        // can draw all kinds of random shapes with
        // it expects radian values -- M_PI
        // BezierPath just draws the outline, so then need to create a CAShapeLayer
    ...
    @IBAction func createGradient(sender: AnyObject) {
        ...
        */
        ...
        // JO: can add as many colors as you want
        ...
        // JO: this is top left corner
        gradient.startPoint = CGPointMake(0, 0)
        
        // JO: this is bottom right
